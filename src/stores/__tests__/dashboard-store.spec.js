...
describe('Dashboard Store', () => {
  ...
  describe('Initial State', () => {
    ...
    it('should have Turkish characters in process names', () => {
      ...
      const hasValueLoss = store.processStats.some(p => 
        p.name.includes('Değer Kaybı')
      )
      const hasBodyDamage = store.processStats.some(p => 
        p.name.includes('Bedeni Hasar İhtiyari')
      )
